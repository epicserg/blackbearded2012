...
<body>
  ...
  <table>
    ...
    <tr valign="top">
      ...
      <td id="secondtd"><input name="New Game" id="newgame" type="button" value=

      "New Game" onclick="top.location.href='playboardnewgame.jsp'" /><br />
      ...
      <td id="thirdtd"><img src="pictures/4.jpg" alt="game logo" /></td>
  ...
  </table><script type="text/javascript" src="Javascript/facebook.js">
